...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(1, 30, 3, 1)   # self.conv1 = nn.Conv2d(1, 32, 3, 1)       # ------  check 4 vec def ---
        self.conv2 = nn.Conv2d(30, 60, 3, 1)  # self.conv2 = nn.Conv2d(32, 64, 3, 1)
        self.dropout1 = nn.Dropout(0.25)
        self.dropout2 = nn.Dropout(0.5)
        self.fc1 = nn.Linear(8640, 128)  # nn.Linear(9216, 128)
        self.fc2 = nn.Linear(128, 10)        # ---------------   can be nn.Linear(128, 9) ----------------
...
def main():
    ...
    train_loader = DataLoader(dataset1, batch_size=120,  # Training    # maybe change batch sizes - check 2-power
